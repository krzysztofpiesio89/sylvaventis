  ...
  return (
    <div className="w-full md:w-64 flex-shrink-0">
      <div className="bg-surface px-8 pb-8 sm:px-6 sm:pb-6 rounded-lg shadow-sm">
        <div className="mb-10">
          <h3 className="text-[10px] font-bold mb-6 text-accent-gold uppercase tracking-[0.2em] border-b border-white/5 pb-2">
            {t('product_type')}
          </h3>
        ...
        <Button
          ...
          variant="reset"
          className="w-full mt-4 text-[9px] uppercase tracking-widest opacity-50 hover:opacity-100 transition-opacity"
        >
          {t('reset_filters')}
        </Button>
      </div>
